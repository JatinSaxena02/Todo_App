    ...
    <>
      {editFormVisibility===false?(
        <form className='form-group custom-form' onSubmit={handleSubmit}>
          <label style={{marginBottom:'20px',color:'black',fontWeight:'bold',fontSize:'25px'}}>Add your todo-items</label>
        ...
        <form className='form-group custom-form' onSubmit={editSubmit}>
          <label style={{fontSize:'2vw' ,fontWeight:'bold'}}>Update your todo-items</label>
          <div className='input-and-btn'>
              <input type="text" className='form-control' required
